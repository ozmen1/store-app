...
namespace Repositories
{
    public class RepositoryContext : DbContext
    {
        ...
        //yapıcı metod kullanarak dbcontext'imizi veritabanı ile konuşuturuyoruz.
        public RepositoryContext(DbContextOptions<RepositoryContext> options) : base(options)
        {

        }

        //çekirdek dataları oluşturuyoruz. kısayol için: override yaz crtl+space ile metodları gör ve seç.
